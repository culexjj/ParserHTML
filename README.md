...
I usually use NTFS Permissions Reporter Free Edition for cheking the ACL. It isn't easy manage the output files from large drives with windows native tools so I create this parser for the more tricky part
